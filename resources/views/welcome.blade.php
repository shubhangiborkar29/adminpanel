        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="{{asset('uploads/'.$latest_blog->image)}}" width="800px" height="350px" alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">{{$latest_blog->created_at}}</div>
                            <h2 class="card-title">{{$latest_blog->title}}</h2>
                            <p class="card-text">{!! Str::words($latest_blog->description,5,'.....')!!}</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{!! Str::words($d->description,5,'.....')!!}</p>
